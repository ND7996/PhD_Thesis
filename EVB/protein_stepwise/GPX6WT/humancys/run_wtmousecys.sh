...
$HOME/github/qtools/qscripts-cli/q_genrelax.py /home/nayanika/OneDrive/Thesis/EVB/GPX6WT/mousecys/genrelax.proc \
          --top GPX6cys_mouse.top \
          --rs /home/nayanika/OneDrive/Thesis/EVB/GPX6WT/mousecys/run_qdyn.sh \
...
echo '##################################################'
$HOME/github/qtools/qscripts-cli/q_genfeps.py /home/nayanika/OneDrive/Thesis/EVB/GPX6WT/mousecys/genfeps.proc $relax/relax_008.inp relax \
          --rs /home/nayanika/OneDrive/Thesis/EVB/GPX6WT/mousecys/COMMON/run_qdyn.sh \
           --repeats 2 \
           --frames 51 \
           --fromlambda 0.90 \
           --pdb GPX6cys_mouse.pdb \
